...
models <- list(glm2,rf4,gbm5,xgb4,nb1,glm5,rf1,xgb1)
...
h2o.save_ensemble(stack, path = "./h2o-ensemble-model-group1-0828-auc0.7378", force = FALSE, export_levelone = FALSE)

h2o.varimp(gbm5)
write.csv(h2o.varimp(gbm5),'group1_gbm5_importance.csv')
